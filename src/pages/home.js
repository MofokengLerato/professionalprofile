        ...
        <section className="min-h-screen flex items-center pt-24 bg-gray-50 dark:bg-gray-900">
            <div className="max-w-6xl mx auto px-4 grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="animate-fadeUp">
                ...
                <h2 className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-6">IT Graduate | Aspiring Cybersecurity Analyst | Frontend Developer | Virtual Assistant</h2>
